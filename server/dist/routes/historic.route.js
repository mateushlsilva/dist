...
historicRoute.delete('/historic/deletar/userId/:uuid', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const uuid = req.params.uuid;
    yield historic.destroy({
        where: {
            usersId: uuid
...
historicRoute.delete('/historic/deletar/airplaneId/:uuid', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const uuid = req.params.uuid;
    yield historic.destroy({
        where: {
            airplaneId: uuid
